...
-- Module  Version: 5.7
--C:\lscc\diamond\3.9_x64\ispfpga\bin\nt64\scuba.exe -w -n ADC_PLL -lang vhdl -synth synplify -arch xo2c00 -type pll -fin 50 -mdiv 2 -ndiv 8 -trimp 0 -phasep 0 -trimp_r -adiv 3 -bypasss -bypass_divs -bdiv 2 -phase_cntl STATIC -fb_mode 1 -fracn 12583 

-- Sat Feb 17 18:15:20 2018
...
architecture Structure of ADC_PLL is
    ...
    attribute FREQUENCY_PIN_CLKOP of PLLInst_0 : label is "204.800034";
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_CPHASE=>  1, CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  2, 
        PLL_LOCK_MODE=>  0, CLKOS_TRIM_DELAY=>  0, CLKOS_TRIM_POL=> "FALLING", 
        CLKOP_TRIM_DELAY=>  0, CLKOP_TRIM_POL=> "RISING", FRACN_DIV=>  12583, 
