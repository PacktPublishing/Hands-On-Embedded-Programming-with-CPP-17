...
#line 37 "src/libsphinxbase/lm/jsgf_parser.y" /* yacc.c:338  */
...
union YYSTYPE
{
#line 65 "src/libsphinxbase/lm/jsgf_parser.y" /* yacc.c:353  */
...
yyreduce:
  ...
  switch (yyn)
    {
        case 5:
#line 87 "src/libsphinxbase/lm/jsgf_parser.y" /* yacc.c:1645  */
    { jsgf->name = (yyvsp[0].name); }
#line 1281 "y.tab.c" /* yacc.c:1645  */
    break;

  case 7:
#line 91 "src/libsphinxbase/lm/jsgf_parser.y" /* yacc.c:1645  */
    { jsgf->version = (yyvsp[-1].name); }
#line 1287 "y.tab.c" /* yacc.c:1645  */
    break;

  case 8:
#line 92 "src/libsphinxbase/lm/jsgf_parser.y" /* yacc.c:1645  */
    { jsgf->version = (yyvsp[-2].name); jsgf->charset = (yyvsp[-1].name); }
#line 1293 "y.tab.c" /* yacc.c:1645  */
    break;

  case 9:
#line 93 "src/libsphinxbase/lm/jsgf_parser.y" /* yacc.c:1645  */
    { jsgf->version = (yyvsp[-3].name); jsgf->charset = (yyvsp[-2].name);
					 jsgf->locale = (yyvsp[-1].name); }
#line 1300 "y.tab.c" /* yacc.c:1645  */
    break;

  case 10:
#line 97 "src/libsphinxbase/lm/jsgf_parser.y" /* yacc.c:1645  */
    { (yyval.name) = (yyvsp[-1].name); }
#line 1306 "y.tab.c" /* yacc.c:1645  */
    break;

  case 13:
#line 104 "src/libsphinxbase/lm/jsgf_parser.y" /* yacc.c:1645  */
    { jsgf_import_rule(jsgf, (yyvsp[-1].name)); ckd_free((yyvsp[-1].name)); }
#line 1312 "y.tab.c" /* yacc.c:1645  */
    break;

  case 16:
#line 111 "src/libsphinxbase/lm/jsgf_parser.y" /* yacc.c:1645  */
    { jsgf_define_rule(jsgf, (yyvsp[-3].name), (yyvsp[-1].rhs), 0); ckd_free((yyvsp[-3].name)); }
#line 1318 "y.tab.c" /* yacc.c:1645  */
    break;

  case 17:
#line 112 "src/libsphinxbase/lm/jsgf_parser.y" /* yacc.c:1645  */
    { jsgf_define_rule(jsgf, (yyvsp[-3].name), (yyvsp[-1].rhs), 1); ckd_free((yyvsp[-3].name)); }
#line 1324 "y.tab.c" /* yacc.c:1645  */
    break;

  case 18:
#line 115 "src/libsphinxbase/lm/jsgf_parser.y" /* yacc.c:1645  */
    { (yyval.rhs) = (yyvsp[0].rhs); (yyval.rhs)->atoms = glist_reverse((yyval.rhs)->atoms); }
#line 1330 "y.tab.c" /* yacc.c:1645  */
    break;

  case 19:
#line 116 "src/libsphinxbase/lm/jsgf_parser.y" /* yacc.c:1645  */
...
#line 1338 "y.tab.c" /* yacc.c:1645  */
  ...
  case 20:
#line 121 "src/libsphinxbase/lm/jsgf_parser.y" /* yacc.c:1645  */
    { (yyval.rhs) = ckd_calloc(1, sizeof(*(yyval.rhs)));
				   (yyval.rhs)->atoms = glist_add_ptr((yyval.rhs)->atoms, (yyvsp[0].atom)); }
#line 1345 "y.tab.c" /* yacc.c:1645  */
    break;

  case 21:
#line 123 "src/libsphinxbase/lm/jsgf_parser.y" /* yacc.c:1645  */
...
#line 1352 "y.tab.c" /* yacc.c:1645  */
  ...
  case 23:
#line 128 "src/libsphinxbase/lm/jsgf_parser.y" /* yacc.c:1645  */
...
#line 1359 "y.tab.c" /* yacc.c:1645  */
  ...
  case 25:
#line 133 "src/libsphinxbase/lm/jsgf_parser.y" /* yacc.c:1645  */
    { (yyval.atom) = (yyvsp[0].atom); (yyval.atom)->weight = (yyvsp[-1].weight); }
#line 1365 "y.tab.c" /* yacc.c:1645  */
    break;

  case 26:
#line 136 "src/libsphinxbase/lm/jsgf_parser.y" /* yacc.c:1645  */
    { (yyval.rule) = jsgf_define_rule(jsgf, NULL, (yyvsp[-1].rhs), 0); }
#line 1371 "y.tab.c" /* yacc.c:1645  */
    break;

  case 27:
#line 139 "src/libsphinxbase/lm/jsgf_parser.y" /* yacc.c:1645  */
    { (yyval.rule) = jsgf_optional_new(jsgf, (yyvsp[-1].rhs)); }
#line 1377 "y.tab.c" /* yacc.c:1645  */
    break;

  case 28:
#line 142 "src/libsphinxbase/lm/jsgf_parser.y" /* yacc.c:1645  */
    { (yyval.atom) = jsgf_atom_new((yyvsp[0].name), 1.0); ckd_free((yyvsp[0].name)); }
#line 1383 "y.tab.c" /* yacc.c:1645  */
    break;

  case 29:
#line 143 "src/libsphinxbase/lm/jsgf_parser.y" /* yacc.c:1645  */
    { (yyval.atom) = jsgf_atom_new((yyvsp[0].name), 1.0); ckd_free((yyvsp[0].name)); }
#line 1389 "y.tab.c" /* yacc.c:1645  */
    break;

  case 30:
#line 144 "src/libsphinxbase/lm/jsgf_parser.y" /* yacc.c:1645  */
    { (yyval.atom) = jsgf_atom_new((yyvsp[0].rule)->name, 1.0); }
#line 1395 "y.tab.c" /* yacc.c:1645  */
    break;

  case 31:
#line 145 "src/libsphinxbase/lm/jsgf_parser.y" /* yacc.c:1645  */
    { (yyval.atom) = jsgf_atom_new((yyvsp[0].rule)->name, 1.0); }
#line 1401 "y.tab.c" /* yacc.c:1645  */
    break;

  case 32:
#line 146 "src/libsphinxbase/lm/jsgf_parser.y" /* yacc.c:1645  */
    { (yyval.atom) = jsgf_kleene_new(jsgf, (yyvsp[-1].atom), 0); }
#line 1407 "y.tab.c" /* yacc.c:1645  */
    break;

  case 33:
#line 147 "src/libsphinxbase/lm/jsgf_parser.y" /* yacc.c:1645  */
    { (yyval.atom) = jsgf_kleene_new(jsgf, (yyvsp[-1].atom), 1); }
#line 1413 "y.tab.c" /* yacc.c:1645  */
    break;


#line 1417 "y.tab.c" /* yacc.c:1645  */
      default: break;
    }
...
#line 150 "src/libsphinxbase/lm/jsgf_parser.y" /* yacc.c:1903  */
